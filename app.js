    ...
    .then((response) => {
      ...
      if (response.data.items.length > 0)
        for (const item of response.data.items) {
          ...
          axios
            .get(
              `https://api.themoviedb.org/3/movie/${item.id}/videos?api_key=6ce93bc5ff54bdbf126d3a288d7b7c88`
            )
            .then((response) => {
...
document.querySelector("#home").onclick = () => {
  loadPopularOrUpcomingOrTopRatedMovies(
    "Popular",
    "https://api.themoviedb.org/3/movie/popular?api_key=6ce93bc5ff54bdbf126d3a288d7b7c88&language=en"
  );
};
...
document.querySelector("#top-rated").onclick = () => {
  loadPopularOrUpcomingOrTopRatedMovies(
    "Top Rated",
    "https://api.themoviedb.org/3/movie/top_rated?api_key=6ce93bc5ff54bdbf126d3a288d7b7c88&language=en"
  );
};
...
document.querySelector("#upcoming").onclick = () => {
  loadPopularOrUpcomingOrTopRatedMovies(
    "Upcoming",
    "https://api.themoviedb.org/3/movie/upcoming?api_key=6ce93bc5ff54bdbf126d3a288d7b7c88&language=en"
  );
};
...
window.onload = () => {
  loadPopularOrUpcomingOrTopRatedMovies(
    "Popular",
    "https://api.themoviedb.org/3/movie/popular?api_key=6ce93bc5ff54bdbf126d3a288d7b7c88&language=en-US&page=1"
  );
};
